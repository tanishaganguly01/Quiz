...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        questions[1][0] = "Which staement is true about Java?";
        ...
        questions[7][0] = "Which of these are selection statements in Java?";
        questions[7][1] = "break";
        questions[7][2] = "continue";
        questions[7][3] = "for()";
        questions[7][4] = "if()";

        questions[8][0] = "Which of the following is a superclass of every class in Java?";
        questions[8][1] = "ArrayList";
        questions[8][2] = "Abstract class";
        questions[8][3] = "Object class";
        questions[8][4] = "String";

        questions[9][0] = "Which of these keywords are used for the block to be examined for exceptions?";
        questions[9][1] = "check";
        questions[9][2] = "throw";
        questions[9][3] = "catch";
        questions[9][4] = "try";
